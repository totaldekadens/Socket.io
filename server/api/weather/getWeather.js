    ...
    try {
        ...
        response.timeSeries.map((timeStamp) => {
            ...
            if(weatherObject.symbol === 1 || weatherObject.symbol === 2){
                weatherObject.symbol = ("./../assets/weatherImg/sun.png")
                ...
                weatherObject.symbol = ("./../assets/weatherImg/cloudy.png")
                ...
                weatherObject.symbol = ("./../assets/weatherImg/rain.png")
                ...
                weatherObject.symbol = ("./../assets/weatherImg/snowing.png")
            } else if (weatherObject.symbol === 21) {
                weatherObject.symbol = ("./../assets/weatherImg/storm.png")
            }
